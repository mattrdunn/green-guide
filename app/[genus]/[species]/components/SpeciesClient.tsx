...
export default function SpeciesClient({
    ...
    const commonName = 'Swiss Cheese Plant';
                    ...
                    <div className="space-y-6 pb-2 sm:pb-0">
                        <div>
                            ...
                            <p className="mt-4 max-w-3xl text-base text-white/90 sm:text-lg">
                                Architectural leaves, forgiving care, and
                                adaptable growth habits make Monstera deliciosa a
                                staple for bright homes and lush patios alike.
                            </p>
                        </div>
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`rounded-full border px-4 py-2 text-sm font-semibold uppercase tracking-wide text-stone-700 transition dark:text-stone-200 ${
                                    isActive
                ...
                <div className="mt-6 sm:mt-6">
                    {activeTab === 'Overview' ? (
                        ...
                        <div className="rounded-3xl border border-dashed border-stone-300 px-6 py-16 text-center text-sm text-stone-500 dark:border-stone-700 dark:text-stone-300">
                            {tabCopy[activeTab] ?? 'Details coming soon.'}
                        </div>
                    )}
                </div>
            </section>
...
const tabCopy: Record<string, string> = {
    Care: 'Custom care plans are on the way. Soon you will be able to see watering cadence, pruning prompts, and seasonal reminders tailored to your climate.',
    Issues: 'We are curating a troubleshooting flow to diagnose pests, pathogens, and nutrient deficiencies with quick remedies and product picks.',
    'Get Started':
        'Starter kits, accessory recommendations, and potting guides will live here so you can bring your Monstera home with confidence.',
};
